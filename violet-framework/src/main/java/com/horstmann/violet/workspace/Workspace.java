...
import com.horstmann.violet.workspace.editorpart.behavior.ConstraintBehavior;
...
public class Workspace implements IWorkspace
{
    ...
    public IEditorPart getEditorPart()
    {
        if (this.graphEditor == null)
        {
            ...
            behaviorManager.addBehavior(new AddEdgeBehavior(this,this.graphEditor, this.getSideBar().getGraphToolsBar()));
            ...
            behaviorManager.addBehavior(new ConstraintBehavior(this, this.getSideBar().getConstraintChoiceBar()));
        }
    ...
    public void setConstraint1(boolean truthValue)
    {
    	this.Constraint1=truthValue;
    }
    
    public void setConstraint2(boolean truthValue)
    {
    	this.Constraint2=truthValue;
    }
    
    public void setConstraint3(boolean truthValue)
    {
    	this.Constraint3=truthValue;
    }
    ...
    public boolean getConstraint3()
    {
    	return this.Constraint3;
    }
    
    private boolean Constraint1=true;
    private boolean Constraint2=true;
    private boolean Constraint3=true;
