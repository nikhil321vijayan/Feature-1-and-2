...
public class SideBarUI extends PanelUI
{
    ...
    public void installUI(JComponent c)
    {
        ...
        //System.out.println("mmp"+Locale.getDefault());
       // if(sideBar.getDiagramPanel())
        addElementToTaskPane(this.sideBar.getConstraintChoiceBar().getAWTComponent(), constraintToolsTitle, 4);
        int i = 5;
    ...
    @ResourceBundleBean(key = "title.constrainttools.text")
    private String constraintToolsTitle;
