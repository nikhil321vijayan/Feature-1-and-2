...
public class GraphToolsBar implements IGraphToolsBar, ISideBarElement
{
    ...
    public void install(IWorkspace workspace)
    {
        ...
        //this.constraintTools=getStandardConstraintTools(graph);
    ...
    @Override
    public List<GraphTool> getConstraintTools() 
    {
        return this.constraintTools;
    }
...
//    private List<GraphTool> getStandardConstraintTools(IGraph graph)
//    {
//        List<String> constraintTypes = graph.getConstraintPrototypes();
//        
//        List<GraphTool> tools = new ArrayList<GraphTool>();
...
//        {
//            GraphTool aTool = new GraphTool(constraintTypes.get(i));
//            tools.add(aTool);
//        }
//        return tools;
//    }
    ...
    private List<GraphTool> constraintTools;
