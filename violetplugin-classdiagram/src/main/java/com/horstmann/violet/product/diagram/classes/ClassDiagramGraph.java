...
public class ClassDiagramGraph extends AbstractGraph
{
	...
	public List<String> getConstraintPrototypes()
	{
    ...
    private static final List<String> CONSTRAINT_PROTOTYPES = new ArrayList<String>(Arrays.asList(
            "allow multi/diff consisting",
            "allow mutual consisting",
            "show CBO"
    ));
