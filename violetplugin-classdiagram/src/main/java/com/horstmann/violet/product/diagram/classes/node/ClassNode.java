...
//    	if(edge.getToolTip().equals("Is composed of")||edge.getToolTip().equals("Is an aggregate of"))
//    	{
//    		if(super.getWorkspcace().getConstraint1())
//    		{    			
//            	if (endingNode == null) 
//            	{
...
//    	}
    ...
    public boolean checkMultiAndDiffConstraint()
    {
    	boolean answer=true;
    	for(IEdge connectionEdge:super.getConnectedEdges())
    	{
    		if(connectionEdge.getEndNode().getId().getValue().equals(super.getId().getValue()))
    		{
    			//if(connectionEdge)
    			answer=false;
    		}
